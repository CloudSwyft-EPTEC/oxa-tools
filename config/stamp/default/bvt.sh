...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/CloudSwyft-repo/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/CloudSwyft-repo/edx-platform.git
PLATFORM_VERSION=oxa/master.fic
THEME_REPO=https://github.com/CloudSwyft-repo/edx-theme.git
